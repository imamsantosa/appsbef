...
@section('additional-footer')
  ...
  {{----}}
    ...
    <script type="application/javascript">
        $(function(){var a="{{$data['peserta_utara']}}",b="{{$data['peserta_selatan']}}",c="{{$data['panitia_utara']}}",d="{{$data['panitia_selatan']}}",e="{{$data['expo_utara']}}",f="{{$data['expo_selatan']}}",g="{{$data['saintek_utara']}}",h="{{$data['saintek_selatan']}}",i="{{$data['soshum_utara']}}",j="{{$data['soshum_selatan']}}",k="{{$data['ipc_utara']}}",l="{{$data['ipc_selatan']}}",m="{{$data['peserta_expo_utara']}}",n="{{$data['peserta_expo_selatan']}}",o={labels:["Peserta","Panitia","Expo Universitas","Saintek","Soshum","IPC","Peserta Expo"],datasets:[{label:"Utara",fillColor:"rgba(210, 214, 222, 1)",strokeColor:"rgba(210, 214, 222, 1)",pointColor:"rgba(210, 214, 222, 1)",pointStrokeColor:"#c1c7d1",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",data:[a,c,e,g,i,k,m]},{label:"Selatan",fillColor:"rgba(60,141,188,0.9)",strokeColor:"rgba(60,141,188,0.8)",pointColor:"#3b8bba",pointStrokeColor:"rgba(60,141,188,1)",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(60,141,188,1)",data:[b,d,f,h,j,l,n]}]},p=$("#barChart").get(0).getContext("2d"),q=new Chart(p),r=o;r.datasets[1].fillColor="#00a65a",r.datasets[1].strokeColor="#00a65a",r.datasets[1].pointColor="#00a65a";var s={scaleBeginAtZero:!0,scaleShowGridLines:!0,scaleGridLineColor:"rgba(0,0,0,.05)",scaleGridLineWidth:1,scaleShowHorizontalLines:!0,scaleShowVerticalLines:!0,barShowStroke:!0,barStrokeWidth:2,barValueSpacing:5,barDatasetSpacing:1,responsive:!0,maintainAspectRatio:!0};s.datasetFill=!1,q.Bar(r,s)});
    </script>
@endsection