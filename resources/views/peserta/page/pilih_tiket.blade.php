...
@section('additional-footer')
    {{--<script type="text/javascript">--}}
        {{--$(document).ready(function(){--}}
            {{--$('#form-jenis-tiket').on('submit', function(){--}}
                {{--if($('#jenis_tiket').val() == '-'){--}}
                    {{--alert('Anda belum memilih tiket');--}}
                    {{--return false;--}}
                {{--}--}}
    ...
    <script type="application/javascript">
        $(document).ready(function(){$("#form-jenis-tiket").on("submit",function(){return"-"==$("#jenis_tiket").val()?(alert("Anda belum memilih tiket"),!1):!!confirm("Apakah tiket yang anda masukan sudah benar?")&&void 0})});
    </script>
@endsection